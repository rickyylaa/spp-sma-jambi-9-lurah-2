                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                                        <div class="modal-content">
                                                            <div class="modal-header modal-colored-header bg-dark">
                                                                <h4 class="modal-title" id="tolakModalLabel">Alasan Tolak Pembayaran</h4>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        ...
                                                                        @php
                                                                            $pembayaranDetail = $row->pembayaranDetail->first();
                                                                        @endphp
                                                                        <textarea id="alasan" class="form-control" rows="5" placeholder="Masukan alasan penolakan" readonly>
                                                                            {{ old('alasan', $pembayaranDetail ? $pembayaranDetail->alasan : '') }}
                                                                        </textarea>
