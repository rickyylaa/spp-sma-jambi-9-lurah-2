...
(function(l) {
	...
	function ma(a) {
		...
		if (a) {
			...
			!a.sEmptyTable && d && "Tidak ada data yang tersedia dalam tabel" === b.sEmptyTable && X(a, a, "sZeroRecords", "sEmptyTable");
	...
	function T(a, b, c, d) {
		...
		if (k === q) return a.iDrawError != e && null === g && (da(a, 0, "Parameter yang diminta tidak diketahui " + ("function" == typeof h.mData ? "{function}" : "'" + h.mData + "'") + " for row " + b + ", column " + c, 4), a.iDrawError = e), g;
		if ((k === f || null === k) && null !==
			g && d !== q) k = g;
